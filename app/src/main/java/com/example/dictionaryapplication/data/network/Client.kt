...
import com.example.dictionaryapplication.util.Constant.TEXT
...
import com.example.dictionaryapplication.util.Parameters.OUTPUT_FORMAT
...
object Client {
    ...
    fun detectRequest(): Status<List<DetectData>>{
        val formBody = formBody
